            ...
            blocks: [
              {
                ...
                head: ["Name", "Address"],
                rows: [
                  ["$BLUR", "0x8ecea3d0e648db646d824aa51eedeb16ac3d6878"],
              ...
              {
                type: "note",
                text: "Only the token is deployed today. Any address circulating as a BLUR vault is not one — check here first, and never approve a contract you found in a direct message.",
              },
            ],
          },
          {
